...
class ConvFeatNet(nn.Module):
    ...
    def forward(self, x1, x2, x3):
        ...
        x = torch.cat([xx1, xx2[:, :, :xx1.shape[-1]]], 1)
...
class PointNetDet(nn.Module):
    def __init__(self, input_channel=3, num_vec=0, num_classes=2):
        ...
        self.reg_out = nn.Conv1d(512, output_size, 1)
        self.cls_out = nn.Conv1d(512, 2, 1)
    ...
    def forward(self,
        ...
        feat1, feat2, feat3 = self.feat_net(
            object_point_cloud_xyz,
            [center_ref1, center_ref2, center_ref3],
